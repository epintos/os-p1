...
/* Deserializes msg and returns the map necessities */
...
/* Deseralizes msg and returns a process id */
int getID(char* msg);

/* Serializes the option indicating that medicines are left in the initial city */
int sendInitialMed(int id, int dest_id);

/* Serializes the map necessities*/
